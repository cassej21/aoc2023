...
file = open('/home/jake/adventofcode/day5/input.txt', 'r')
...
maps = []
maps.append(genMapArr(3,44))
maps.append(genMapArr(47,95))
maps.append(genMapArr(98,129))
maps.append(genMapArr(132,178))
maps.append(genMapArr(181,201))
maps.append(genMapArr(204,240))
maps.append(genMapArr(243,278))
